 ...
 *
 * <p>This service performs no PTU calculations. The trusted server caller supplies final health,
 * status metadata, and injury state. The service verifies canonical identity, owner and frozen
 * revision before advancing the durable Pokemon aggregate. An exact retry against the immediately
 * advanced revision is idempotent; conflicting or older writes fail closed.</p>
 */
