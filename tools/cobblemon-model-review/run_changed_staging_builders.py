...
This is intentionally species-agnostic. It discovers changed builder scripts under
`tools/cobblemon-model-review/` and executes only builders whose filenames follow
`build_*_v<digits>.py`. Builders remain responsible for refusing production paths.
"""
