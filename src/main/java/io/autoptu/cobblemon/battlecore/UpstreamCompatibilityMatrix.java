...
public final class UpstreamCompatibilityMatrix {
    public static final String AUTOPTU_JAVA_SHA = "cd510f3cd812532ae84304b01377c34a285863c5";
    ...
    private static Map<Capability, Entry> buildEntries() {
        ...
        entries.put(Capability.ABILITIES, partial(
                "Canonical ability identities, generic HookSource support, ordered AbilityPhaseEffectRegistry, default-lifecycle ability phase dispatch, parity-backed Mega Launcher damage behavior, Strange Tempo Confusion START behavior, Inner Focus Flinch prevention and Lancer END phase behavior",
        ...
        entries.put(Capability.TRAINER_FEATURES_AND_PERKS, partial(
                "Selected status-skip Trainer Feature exceptions, TRAINER_FEATURE/PERK hook-source and lifecycle categories, and a stable PERK family position after status and ability phase families in CombatantPhaseEffectDispatcher; concrete default perk phase behavior remains unported",
        ...
        entries.put(Capability.MINECRAFT_COBBLEMON_CRAFTICS_ADAPTER_PLAYBACK, blocking(
                "Semantic battle-event contracts and project-owned headless playback/world-projection DTOs exist, including phase, turn-end and generic rule-effect projection for current upstream lifecycle/ability events, but no verified live Minecraft/Cobblemon/Craftics runtime adapter has executed them",
