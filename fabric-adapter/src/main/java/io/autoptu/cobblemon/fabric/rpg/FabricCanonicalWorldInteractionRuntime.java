        ...
        UseBlockCallback.EVENT.register((player, world, hand, hitResult) -> {
            ...
            if (object.kind() == CanonicalWorldInteractionService.Kind.TERMINAL) {
                ...
                if (objectiveEvent.changed()) {
                    serverPlayer.sendMessage(Text.literal("Quest updated: you inspected the Cedar Ranger's field notes."), false);
                } else {
                    serverPlayer.sendMessage(Text.literal("Cedar Ranger field notes inspected."), false);
                }
                return ActionResult.SUCCESS;
            }
