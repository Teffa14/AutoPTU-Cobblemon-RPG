...
public final class FabricRpgContent {
    ...
    public static final Identifier CEDAR_LEAGUE_BADGE_GATE_ID = Identifier.of(MOD_ID, "cedar_league_badge_gate");
    ...
    /** Physical progression gate. Badge ownership comes only from the durable Trainer record ledger. */
    public static final Block CEDAR_LEAGUE_BADGE_GATE = new Block(
            AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(5.0F).requiresTool()
    );
    public static final Item CEDAR_LEAGUE_BADGE_GATE_ITEM = new BlockItem(CEDAR_LEAGUE_BADGE_GATE, new Item.Settings());
    ...
    public static void register() {
        ...
        Registry.register(Registries.BLOCK, CEDAR_LEAGUE_BADGE_GATE_ID, CEDAR_LEAGUE_BADGE_GATE);
        Registry.register(Registries.ITEM, CEDAR_LEAGUE_BADGE_GATE_ID, CEDAR_LEAGUE_BADGE_GATE_ITEM);
        registered = true;
    }
}
