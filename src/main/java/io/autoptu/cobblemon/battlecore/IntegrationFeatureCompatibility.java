...
public final class IntegrationFeatureCompatibility {
    ...
    private static Map<Feature, Requirement> buildRequirements() {
        ...
        requirements.put(Feature.CANONICAL_INJURY_BOOTSTRAP, requirement("Bind frozen injury counts to the exact authoritative battle reservation and roster as input for future core runtime contracts. Minecraft/client payloads may not supply injury counts or execute Aura Storm/Aura Break arithmetic from them.", UpstreamCompatibilityMatrix.Capability.FULL_STATEFUL_DAMAGE_PIPELINE, UpstreamCompatibilityMatrix.Capability.ABILITIES));
