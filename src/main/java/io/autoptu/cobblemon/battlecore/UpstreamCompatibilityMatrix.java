...
public final class UpstreamCompatibilityMatrix {
    public static final String AUTOPTU_JAVA_SHA = "260ca29699e34d56da8fb32d43d2b6de7dba6892";
    ...
    private static Map<Capability, Entry> buildEntries() {
        ...
        entries.put(Capability.FULL_STATEFUL_DAMAGE_PIPELINE, partial(
                "RuntimeMoveResolution, authoritative stats/types/statuses, ordered DamageModifierHookRegistry, pre-damage move hooks and ordered PostDamageHookRegistry/PostDamageHookResult; Burn, Pink Pearl, Mega Launcher, actual-HP-loss move-damage-history recording, Aqua Boost/Ignition Boost/Thunder Boost, Power Spot and Type Aura post-result aura selection are parity-backed. Normal Aura Storm is now live-wired through canonical MoveSpec Aura keywords, BattleRuntimeState.injuryHistory current injuries and the authoritative global AuraBreakBlockerQuery; distant active non-fainted enemy exact-base Aura Break suppresses it. AuraStormResolution also freezes normal/errata formulas and shared AuraBreakErrataAdjustment freezes reusable ability-targeted inversion/expiry semantics. BattleRuntime applies resolved wired post-damage flat bonuses before authoritative HP mutation, MoveResolvedEvent emission and move-damage-history recording",
        ...
        entries.put(Capability.ABILITIES, partial(
                "Canonical ability identities, generic HookSource support, AbilityPhaseEffectRegistry, CombatStageHookRegistry, PostDamageHookRegistry and parity-backed Mega Launcher, Strange Tempo, Inner Focus, Lancer, Simple, Defiant, Competitive, Plus [SwSh], Minus [SwSh], Aqua Boost, Ignition Boost, Thunder Boost, Power Spot and Type Aura behavior. Normal Aura Storm is live-wired through authoritative current injuries and AuraBreakBlockerQuery; exact base Aura Break blockers are global, active, non-fainted enemies in deterministic combatant order, while Aura Break [Errata] is excluded from that base query. AuraStormResolution freezes normal and errata formulas and shared AuraBreakErrataAdjustment freezes reusable Aura Break [Errata] inversion/expiry behavior; spatial abilities use authoritative positions, team identity, active/HP state, deterministic holder order and recursive hook suppression where applicable",
