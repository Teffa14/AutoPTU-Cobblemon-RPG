...
public final class IntegrationFeatureCompatibility {
    ...
    private static Map<Feature, Requirement> buildRequirements() {
        ...
        requirements.put(Feature.LIVE_MINECRAFT_BATTLE_ADAPTER, requirement("Runtime-tested support is currently limited to production Fabric/Cobblemon startup, opaque PokemonEntity UUID lookup and an entity-bound authoritative relocation whose final server position is verified. HP projection, move animation, semantic cues, battle-trigger interception and full battle playback remain outside this bounded slice.", UpstreamCompatibilityMatrix.Capability.MINECRAFT_COBBLEMON_CRAFTICS_ADAPTER_PLAYBACK));
