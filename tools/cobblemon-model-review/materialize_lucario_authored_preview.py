...
def main():
    ...
    cgeo["description"]["identifier"]="geometry.ouros_aura_sentinel_v44_preview"
    added=[]
    ...
    out_model=a.output_dir/"lucario_v44_preview.geo.json"
    ...
    for i,rgba in enumerate(PALETTE):
        ...
        px[x,y]=rgba
    out_tex=a.output_dir/"lucario_v44_preview.png"; img.save(out_tex)
    report={"format":"ouros.blockbench-preview-materialization.v1","species":"lucario","concept":patch["concept"],"artStatus":"ARTISTIC FAIL","reviewState":"BLOCKBENCH_REVIEW_PENDING","officialModelSha256":sha256(a.official_model),"officialTextureSha256":sha256(a.official_texture),"candidateModelSha256":sha256(out_model),"candidateTextureSha256":sha256(out_tex),"officialBoneCount":OFFICIAL_BONES,"derivedBoneCount":len(cgeo["bones"]),"cosmeticBoneCount":len(added),"cosmeticGroups":added,"textureMode":"DERIVED_FROM_OFFICIAL_PREVIEW_ONLY","repaintScope":"Eight previously transparent 1px atlas palette slots at x=80..87,y=63; biological texels unchanged.","artApproval":"NOT_GRANTED"}
