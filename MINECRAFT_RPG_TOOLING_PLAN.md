...
| FAC-002 | LIVE/PARTIAL | Shop catalogue/stock/price service. PR #247 / implementation head `36870beb75976891d0d4ebbe2f1edfaf78423e36` adds the reusable authored catalogue/query boundary. PR #250 / implementation head `748a57efc20678962f65efad9d4feb7450bafd54` adds world-save-scoped remaining stock, first-read provisioning from the authored cap, revision-CAS depletion primitives, restart persistence and current-stock projection through the same shop query. Buy/sell orchestration, exactly-once cross-store commit and replenishment policy remain TODO. |
