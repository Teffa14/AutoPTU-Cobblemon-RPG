...
| CUR-023 | LIVE | server-authored shop catalogue read surface | PR #247 / implementation head `36870beb75976891d0d4ebbe2f1edfaf78423e36`. `/autoptu shop` and `/autoptu shop list [shop]` expose only server-authored offer IDs, item templates, currency IDs, prices and stock caps after resolving the authenticated Trainer. No purchase or PTU item effect is performed. |
...
| CMD-081 | LIVE | `/autoptu shop list [shop]` — PR #247 / implementation head `36870beb75976891d0d4ebbe2f1edfaf78423e36`; reads the authenticated Trainer plus the server-authored shop catalogue through `inspectShop`, exposing no client-authored price, currency, template or stock truth. |
...
| FAC-002 | LIVE/PARTIAL | Shop catalogue/stock/price service. PR #247 / implementation head `36870beb75976891d0d4ebbe2f1edfaf78423e36` adds the reusable server-authored catalogue/query boundary with immutable offer IDs, item templates, currency IDs, unit prices and stock caps plus the authenticated read surface. Mutable stock depletion and buy/sell transaction orchestration remain TODO. |
...
| SVC-028 | LIVE | `inspectShop(player, shopId)` — PR #247 / implementation head `36870beb75976891d0d4ebbe2f1edfaf78423e36`; resolves a server-authored catalogue snapshot for an authenticated canonical Trainer and exposes authored offer metadata only. It performs no wallet/item mutation and accepts no trusted client price, stock, currency or template data. |
