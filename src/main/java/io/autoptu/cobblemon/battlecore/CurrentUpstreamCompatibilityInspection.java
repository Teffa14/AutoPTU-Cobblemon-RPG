...
public final class CurrentUpstreamCompatibilityInspection {
    ...
    public static final String AUTOPTU_PYTHON_SHA = "2c98c2201a65a370bbe4999616c2c737d407a32e";
    ...
    private static Map<UpstreamCompatibilityMatrix.Capability, Evidence> build() {
        ...
        result.put(UpstreamCompatibilityMatrix.Capability.ABILITIES,
                new Evidence(
                        UpstreamCompatibilityMatrix.Support.PARTIAL,
                        "Initiative-time ability behavior and delayed-hit combat preparation read authoritative runtime state and rerun authoritative move/damage/post-damage hooks during ROUND_START. Upstream draft PR #152 freezes declarative status-prevention ability mapping, but that draft does not change live status application and is not treated as runtime support.",
