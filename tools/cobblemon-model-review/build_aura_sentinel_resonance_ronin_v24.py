...
def cosmetic_bones():
    ...
    sweep=v1.bone('ouros_v24_mantle_sweep','torso3',[-4.0,29.0,1.1],[shell((-11.3,28.6,0.3),(7.4,1.25,4.0),81,pivot=(-6.0,30.0,0.8),rotation=(9,-25,44),light=81,dark=90),shell((-12.9,32.2,0.9),(6.6,1.05,3.3),80,pivot=(-8.0,33.0,1.2),rotation=(5,-17,58),light=83,dark=90),shell((-12.4,36.2,1.4),(5.2,0.82,2.6),81,pivot=(-9.0,36.6,1.5),rotation=(-2,-9,69),light=84,dark=89)])
