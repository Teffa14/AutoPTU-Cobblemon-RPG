...
| WORLD-022 | NEXT/PARTIAL | Camp interaction. PR #240 / implementation head `f0d550ded5abe248ce65ed6f463c9076b7955ec1` adds a physical campfire-over-barrel authored camp surface that assesses server-owned `field_camp_setup` readiness from the authenticated Trainer's canonical Survival rank. It consumes no PTU action cost/frequency, performs no PTU roll, and grants no healing/reward/result. Next: add an actual server-owned camp activity/commit behind this surface without synthesizing blocked PTU Feature policy. |
...
| SVC-021 | LIVE/PARTIAL | `assessWorldTask(player, task, context)` — PR #226 / `2de8d720428b98a6d7375e793a89b5ff20e9c14c` reads canonical Trainer capabilities and applies server-authored Ouros task quality curves; PR #227 adds the normal-world crafting workstation consumer; PR #240 / implementation head `f0d550ded5abe248ce65ed6f463c9076b7955ec1` reuses the same authority boundary for a physical Survival-based field camp. Continue reusing this boundary for cooking, technology, medicine, research, occultism, repairs and other non-battle world interactions. |
