...
public final class AreaSecondaryStatusCompatibility {
    ...
    public static final String AUTOPTU_PYTHON_MAIN_SHA =
            "2976b6047702d2e86d367fdad3d648e35ced4145";
    ...
    public static String combatStageBoundary() {
        return "AutoPTU-Java PR #211 through PR #226 establish increasingly complete server-owned Combat Stage and Accuracy inputs, including intrinsic Accuracy CS, temporary Accuracy contracts, Focused Training ownership, Chronicler metadata, canonical Chronicler profile matching, and targeted_profiling bonus resolution. "
                + "PR #226 is merged on Java main at c5ef1d72c8a997144d215423e2aab60d706905a9. Its resolver owns expiry, stacking, source-controller fallback and +2 matching bonuses over server-owned temporary effects, while deliberately accepting a server-owned profile matcher. "
                + "PR #226 still leaves runtime ownership of Chronicler metadata and combatant identity plus live Accuracy preparation to later work. "
    ...
    public static String pythonOracleObservation() {
        return "AutoPTU Python main 2976b6047702d2e86d367fdad3d648e35ced4145 changes Career recovery decision-progress validation and does not replace the pinned battle oracle. "
                + "Battle parity remains pinned to AutoPTU 16d228efa63aabecb67fa788959a359aac7f8f03. Java PR #225 freezes _chronicler_profile_matches() and merged PR #226 freezes _chronicler_accuracy_bonus() behavior against that oracle without wiring the result into live Accuracy.";
    }
}
